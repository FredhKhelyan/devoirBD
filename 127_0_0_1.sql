...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 14 nov. 2024 à 09:55
...
CREATE TABLE `formation` (
  ...
  `dureeForm` int(11) NOT NULL,
  `prixForm` decimal(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `appartient`
  ADD CONSTRAINT `appartient_ibfk_1` FOREIGN KEY (`codeForm`) REFERENCES `formation` (`codeForm`),
  ADD CONSTRAINT `appartient_ibfk_2` FOREIGN KEY (`codeSpec`) REFERENCES `specialite` (`codeSpec`);

--
-- Contraintes pour la table `est_inscrit`
--
ALTER TABLE `est_inscrit`
  ADD CONSTRAINT `est_inscrit_ibfk_1` FOREIGN KEY (`NumCINEtu`) REFERENCES `etudiant` (`NumCINEtu`),
  ADD CONSTRAINT `est_inscrit_ibfk_2` FOREIGN KEY (`codeSess`) REFERENCES `session` (`codeSess`);
...
('root', '[{\"db\":\"centre_formation\",\"table\":\"etudiant\"},{\"db\":\"centre_formation\",\"table\":\"appartient\"}]');
...
('root', '2024-11-14 08:47:57', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
